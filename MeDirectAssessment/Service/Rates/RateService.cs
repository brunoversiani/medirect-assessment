...
namespace MeDirectAssessment.Service.Rates
{
    public class RateService : IRateService
    {
        ...
        public async Task<TransactionModel> NewExchangeWithOldRateService(TransactionModel transactionModel, double amount)
        {
        ...
        private async Task<TransactionModel> AddTransactionService(string clientId, RestResponse response)
        {
